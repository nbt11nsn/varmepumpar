...
<div id="main-wrapper">
 <div id="infoframe">
	...
	<div id ="informationtesttext">
		...
		<br><br>OBS! Om inte alla obligatoriska delar är ifyllda och sparade så kommer ingen information att synas i fliken "Översikt". Om det är någon fråga du inte kan svara på så skriv "Vet ej".
	</div>	
